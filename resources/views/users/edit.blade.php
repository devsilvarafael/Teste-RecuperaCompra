...
<body class="bg-[#f8f8f8]">
    ...
    <div class="md:px-12 md:pt-12">
        <div class="flex flex-col items-center justify-center mt-28">
            ...
            <h1 class="text-3xl">Editar usuário</h1>

            <p class="mb-2">Preencha todos os dados</p>

            <form action="{{ route('users.update', $user->id) }}" method="POST" class="w-[600px]">
                @csrf
                @method('PUT')
                <div class="my-4">
                ...
                <div class="my-4">
                    ...
                    <div class="col-md-6">
                        ...
                        @error('password')
                            <span role="alert">
                                <strong class="my-10">{{ $message }}</strong>
                            </span>
                        @enderror
                    </div>
                </div>
                ...
                <div class="my-4">
                    ...
                    <div>
                        <input id="password-confirm" type="password" name="password_confirmation" autocomplete="" />
                    </div>
                </div>
